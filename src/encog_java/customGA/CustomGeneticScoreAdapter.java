 ...
 */
public class CustomGeneticScoreAdapter implements CalculateGenomeScore {

        // private final Population population; //need the population in this custom implementation
	 ...
	 */
	public CustomGeneticScoreAdapter(final CalculateScore calculateScore, Population pop) {
		this.calculateScore = calculateScore;
		this.calculateScore.setPopulation(pop);
		//population = pop;
	}
